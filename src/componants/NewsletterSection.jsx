        ...
        <div className="relative md:px-16 py-16 px-6 md:py-24">
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className=" max-w-lg text-center md:text-left">
              <h2 className=" text-white text-2xl sm:text-3xl lg:text-4xl font-medium mb-4">
                Subcribe Newsletter
              </h2>

              <p className="text-blue-100 text-sm sm:text-balance">
                best cooks & best delevery guys al at your service. Hot tasty
                food
              </p>
            </div>
