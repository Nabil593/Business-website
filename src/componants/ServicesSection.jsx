      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24">
        ...
        <div className="w-full md:w-1/2">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 md:w-4/5">
            Future of support with new shap
          </h2>
          <p className="text-gray-600 text-lg mb-4 md:w-4/5">
            Discuss your goals, Detarmine success matrics, Identify problems
          </p>
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">UX design content stategy</span>
            </div>
