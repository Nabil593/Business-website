...
const PriceSection = () => {
  const [productCunt, setproductCunt] = useState(1);

  //calculate product price base on product count
  const startPrice = Math.round(4000 * (productCunt / 50));
  const businessPrice = Math.round(7500 * (productCunt / 50));
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="relative px-4">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                max="50"
                value={productCunt}
                onChange={(e) => setproductCunt(parseInt(e.target.value))}
              />
          ...
          <div className="text-center mt-5">
            ...
            <button className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all cursor-pointer">
              Get Started
            </button>
          </div>
        </div>
